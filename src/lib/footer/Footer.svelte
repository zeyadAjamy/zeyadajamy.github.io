...
<footer>
	<div class="footer-content">
		<div class="footer-about">
			...
			<div class="about-social-icons">
				<a target="_blank" href="https://www.facebook.com/">
					<img src={facebook} class="footSocial" alt="facebook" /></a
				>
				<a target="_blank" href="https://www.instagram.com/">
					<img src={instagram} class="footSocial" alt="instagram" /></a
				>
				<a target="_blank" href="https://www.linkedin.com/">
					<img src={linkedin} class="footSocial" alt="linkedin" /></a
				>
				<a target="_blank" href="https://twitter.com/">
					<img src={twitter} class="footSocial" alt="twitter" /></a
				>
			</div>
		</div>
		<div class="footer-menu">
			...
			<ul>
				...
				<li class:active={$page.url.pathname === '/about'}>
					...
					<a sveltekit:prefetch href="{base}/about" content="About Me"> About Me </a>
				</li>
		...
		<div class="footer-service">
			...
			<ul>
				<li>
					<img src={right_arrow} class="fa-right-arrow" alt="" /> <a href={base}> Web Design </a>
				</li>
				<li>
					<img src={right_arrow} class="fa-right-arrow" alt="" />
					<a href={base}> Web Development </a>
				</li>
				<li>
					<img src={right_arrow} class="fa-right-arrow" alt="" />
					<a href={base}> Cross platform App </a>
				</li>
			</ul>
		</div>
		<div class="footer-contact">
			...
			<ul>
				<li>
					<img src={envelope} class="fa-email" alt="Envelope Icon" />
					<span> wezza2003@gmail.com </span>
				</li>
				<li>
					<img src={phone} class="fa-phone" alt="Phone Icon" />
					<span> +20 (11) 192 365 35 <br /> +7 (987) 729 336 61 </span>
				</li>
			</ul>
		</div>
	</div>
	<p class="copyrights">
		Copyright &copy;2022 All rights reserved | Made with <span class="heart">&hearts;</span> by Zeyad
		Alagamy
	</p>
</footer>
