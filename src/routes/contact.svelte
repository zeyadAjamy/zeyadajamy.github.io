...
<section class="contact">
    <h1> Contact Me</h1>
    <p class=""> I'd love to hear from you! </p>
    <div class = "contact-main">
        <div class="card">
            ...
            <p class="card-info"> wezza2003@gmail.com </p>
        </div>
        <div class="card">
            <div class="card-header">
                <div class="img-container">
                ...
                <span class="card-title"> Contact Numbers </span>
            </div>
            <p class="card-info">  +20 (11) 192 365 35 <br>  +7 (987) 729 336 61  </p>
        </div>
        <div class="card">
            <div class="card-header">
                <div class="img-container">
                    <img src ={share_nodes} alt="email">
                </div>
                <span class="card-title"> Social media </span>
            </div>
            <div class="social-icons">
                <a target="_blank" href="https://www.facebook.com/"> <img src={facebook} class="footSocial" alt="Facbeook Icon"> </a>
                <a target="_blank" href="https://www.instagram.com/"> <img src={instagram} class="footSocial" alt="Instagram Icon"></a>
                <a target="_blank" href="https://www.linkedin.com/"> <img src={linkedin} class="footSocial" alt="Linkedin Icon"> </a>
                <a target="_blank" href="https://twitter.com/"> <img src={twitter} class="footSocial" alt="Twitter Icon">  </a>
            </div>
        </div>
    </div>
    <div class="message">
