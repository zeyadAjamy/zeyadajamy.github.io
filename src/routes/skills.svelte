...
<script lang="ts">
	...
	function circleProgress(object: HTMLElement) {
		...
		if (percent == undefined) {
			...
			if (percent <= 50) {
				// then we should hide the second half of the circle
	...
	onMount(() => {
		let allCircularBars: NodeListOf<HTMLElement> =
			progressBars.querySelectorAll('.circular-progress-bar');
		for (let i = 0; i < allCircularBars.length; i++) {
			circleProgress(allCircularBars[i]);
		}

		let allLinearBars: NodeListOf<HTMLElement> =
			progressBars.querySelectorAll('.linear-progress-bar');
	...
	<div class="skills-container">
		<div class="skills-content" bind:this={progressBars}>
			...
			<div class="linear-container">
				<div class="linear-progress-bar" data-percentage="80%" data-label="Sass" />
				<div class="linear-progress-bar" data-percentage="90%" data-label="PugJs" />
				<div class="linear-progress-bar" data-percentage="95%" data-label="JSON/Ajax" />
				<div class="linear-progress-bar" data-percentage="75%" data-label="UI/UX" />
				<div class="linear-progress-bar" data-percentage="40%" data-label="NodeJS" />
				<div class="linear-progress-bar" data-percentage="50%" data-label="VueJS" />
				<div class="linear-progress-bar" data-percentage="80%" data-label="Bootstrap" />
				<div class="linear-progress-bar" data-percentage="60%" data-label="Java" />
			</div>
		</div>
	</div>
</section>
